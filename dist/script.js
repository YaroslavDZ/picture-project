...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (sizeBlock.value === '' || materialBlock.value === '') {
      ...
      resultBlock.textContent = Math.round(sum - sum / 100 * 30);
    } else {
...
/* harmony import */ var _services_requests_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/requests.js */ "./src/js/services/requests.js");
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.querySelector('.button').setAttribute('type', 'submit');
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests_js__WEBPACK_IMPORTED_MODULE_4__["postData"])(api, formData).then(function (res) {
